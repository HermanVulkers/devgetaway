  ...
  return (
    <>
      ...
      <Styled.Container>
        ...
        <p>
          By using our platform (hereinafter referred to as "the platform"), you
        ...
        <p>
          ...
          If you do not agree to these terms, you should not access or use the
          platform.
        </p>
        ...
        <p>
          ...
          and keep your account information up-to-date. You are responsible for
        ...
        <p>
          ...
          responsible for all the activities related to home swapping and any
          repercussions that may result. The platform merely provides a service
          of connecting users and does not take responsibility for any damages
        ...
        <p>
          ...
          use the platform to post or share content that is harmful, offensive,
          obscene, abusive, invasive of privacy, defamatory, hateful or
          otherwise discriminatory, false or misleading, or incites an illegal
          act.
        </p>
        ...
        <p>
          ...
          you agree to the collection, use, and sharing of your information in
        ...
        <p>
          ...
          losses (even if the platform has been advised of the possibility of
        ...
        <p>
          ...
          liabilities, expenses, damages, and costs, including but not limited
          to attorneys' fees, resulting from or arising out of your use of the
        ...
        <p>
          ...
          Arbitration Institute. You and the platform agree to submit to the
          exclusive jurisdiction of the courts of the Netherlands to resolve any
